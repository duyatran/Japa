...
public class Processing {
	...
	// private
	private static boolean canvasCreated = false; // to deal with multiple calls
													// to size()
	 ...
	 * windows (in pixels) with default pa rameters (800 x 600). It must be the
	...
	/**
	 * @param width
	 *            : Desired width of the display window.
	 * @param height
	 *            : Desired height of the display window.
	 */
	 ...
	 * 
	 * @param mode
	 *            : Either Consts.RGB or Consts.HSB.
	 */
	 ...
	 *            : Either Consts.RGB or Consts.HSB
	 * @param max
	 *            : Maximum value of the range of all color components
	 */
	 ...
	 *            : Either Consts.RGB or Consts.HSB
	 * @param max1
	 *            : Maximum value of the range of the red or hue component
	 * @param max2
	 *            : Maximum value of the range of the green or saturation
	 *            component
	 * @param max3
	 *            : Maximum value of the range of the blue or brightness
	 *            component
	 */
	 ...
	 *            component
	 * @param maxA
	 *            : Maximum value of the range of the alpha value
	 */
	 ...
	 * 
	 * @param v1
	 *            : red or hue component
	 * @param v2
	 *            : green or saturation component
	 * @param v3
	 *            : blue or brightness component
	 */
	...
	/**
	 * LOW-PRIORITY TO-DO: Sets the background of the display window to an
	 * image.
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Sets the style for rendering stroke endings. Default stroke cap is
	 * SQUARE.
	 * 
	 * @param cap
	...
	/**
	 * Sets the style of the joints between strokes. Default stroke join is
	 * MITER.
	 * 
	 * @param join
	 ...
	 * 
	 * @param x
	 *            : x-coordinate of the center of the arc's ellipse
	 * @param y
	 *            : y-coordinate of the center of the arc's ellipse
	 * @param w
	 *            : width of the arc's ellipse
	 * @param h
	 *            : height of the arc's ellipse
	 ...
	 * 
	 * @param v1
	 *            : by default, x-coordinate of the top left corner of the
	 *            rectangle
	 * @param v2
	 *            : by default, y-coordinate of the top left corner of the
	 *            rectangle
	 * @param v3
	...
	/**
	 * Save canvas as an image file supports png, jpeg, bmp, gif; jpg not
	 * recommended default is png if no explicit extension is given
	 * 
	 * @param filename
	 * @throws IOException
	 */
