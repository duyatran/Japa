...
public class A3Demo18 {
	...
	public static void drawSide(int fgH, int fgS, int fgB, int cornerX,
			int cornerY) {
	...
	public static void drawFish(double centerX, double centerY, double fishSize) {
		...
		Processing.noStroke();
		Processing.triangle(centerX + fishSize / 2, centerY,
				centerX + fishSize, centerY - fishSize / 6, centerX + fishSize,
				centerY + fishSize / 6);
	}
