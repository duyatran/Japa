...
public class ProcessingShape extends Shape
{
	 ...
	 */
	 ...
	 public void addVertex(double x, double y){
		 ...
		 case Consts.LINES:
			 if ((vertexCount % 2) == 0) {
				 shapeList.add(new ProcessingLine(vertices.get(vertexCount-2).getX(),
						 vertices.get(vertexCount-2).getY(), x, y, att));
			 }
			 break;
		 ...
		 case Consts.TRIANGLE_FAN:
			 if (vertexCount >= 3) {
				 // From Processing: This is an unfortunate implementation because the stroke for an
				 ...
				 // polygon fill, followed by a series of verticesSet. But that's a
