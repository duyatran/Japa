...
public class A3Demo21 {
	...
	public static void draw() {
		Processing.background (32, 41, 88);
		  ...
		  if (( rightCloud+windCount-105>Processing.width ) || (bottomRight+windCount+105<0)) {
		    dir=dir*-1;
		  }
	...
	public static void theTent() {
	  theFlag(.5*Processing.width, .40*Processing.height, .55*Processing.width, .45*Processing.height, .5*Processing.width, .45*Processing.height, .5*Processing.height);
	  theRoof(.5*Processing.width, .5*Processing.height, .75*Processing.width, .75*Processing.height, .25*Processing.width, .75*Processing.height);
	  theBody(.3*Processing.width, .75*Processing.height, 18, .2*Processing.height);
	}
	//Create the Flag on top of the Tent
	public static void theFlag( double TopX, double TopY, double RightX, double RightY, double BottomX, double BottomY, double BottomYY) {
	...
	public static void theRoof( double ToppX, double ToppY, double RighttX, double RighttY, double LefttX, double LefttY) {
		Processing.fill(142, 23, 10);
		Processing.noStroke();
		Processing.triangle(ToppX, ToppY, RighttX, RighttY, LefttX, LefttY);
		Processing.fill(255);
		Processing.triangle(ToppX, ToppY, .3*Processing.width, RighttY, .7*Processing.width, LefttY);
		Processing.fill(142, 23, 10);
		Processing.triangle(ToppX, ToppY, .35*Processing.width, RighttY, .65*Processing.width, LefttY);
		Processing.fill(255);
		Processing.triangle(ToppX, ToppY, .4*Processing.width, RighttY, .6*Processing.width, LefttY);
		Processing.fill(142, 23, 10);
		Processing.triangle(ToppX, ToppY, .45*Processing.width, RighttY, .55*Processing.width, LefttY);
		Processing.fill(255);
		Processing.triangle(ToppX, ToppY, .52*Processing.width, RighttY, .48*Processing.width, LefttY);
	}
	//Create the Body and Opening of the Tent
	public static void theBody( double UpperLeftX, double UpperLeftY, double stripeThickness, double stripeHeight) {
	  int counter=0;
	  ...
	  while (UpperLeftX<.69*Processing.width) {
	    ...
	    Processing.rect(UpperLeftX, UpperLeftY, stripeThickness, stripeHeight);
	    UpperLeftX=UpperLeftX+stripeThickness;
	    counter=counter+1;
	  }
	  Processing.fill(0);
	  Processing.triangle(.5*Processing.width, .75*Processing.height, .45*Processing.width, .95*Processing.height, .55*Processing.width, .95*Processing.height);
	}
	//Create Balloon and String
	public static void theBalloons(double balloonX, double balloonY, double balloonWidth, double balloonHeight) {
		Processing.stroke(3);
