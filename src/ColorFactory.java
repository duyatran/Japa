...
public class ColorFactory {
	private boolean PROCESSING = true; // Using Processing's convention for default values
	...
	/**
	 * Sets the default maximum value for ranges of
	 * color components.
	 */
    ...
    /**
     * This method computes the final color depending on the
     * color mode and maximum values.
     * @param v1
     * @param v2
     * @param v3
     * @param alpha
