...
/**
 * Summer 2015 - Processing-inspired Java Graphics Library ProcessingLine.java
...
public class ProcessingLine extends AbstractShape {
	private double x1;
	private double y1;
	private double x2;
	private double y2;
	...
	/**
	 * Constructs a line with a given starting and ending points.
	 * 
	 ...
	 */
	public ProcessingLine(double x1, double y1, double x2, double y2,
